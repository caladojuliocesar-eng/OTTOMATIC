...
4. CTA: DM ou comentário.`;
    ...
    // Restoring the EXACT model name and version from the original working project
    ...
    return Response.json({ error: `[API v2.4] ${error.message || "Failed to generate carousel"}` }, { status: 500 });
  }
}
